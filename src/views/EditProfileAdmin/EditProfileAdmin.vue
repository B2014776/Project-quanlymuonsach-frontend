  ...
  <div class="containPage">
    ...
    <div class="contentPage">
      <section>
        <div class="container">
          <div class="row">
            <div class="col-lg-4 ju">
              <div class="card mb-4">
                <div class="card-body text-center d-flex flex-column align-items-center">
                  <img :src="imageUploadEdit" alt="avatar" class="rounded-circle img-fluid" style="width: 150px" />
                  <h5 class="my-3">{{ data.HoTenNv }}</h5>
                  <!-- <p class="text-muted mb-1">Khách hàng</p> -->
                  <p class="text-muted mb-4">{{ data.DiaChi }}</p>
                  <div class="d-flex justify-content-center mb-2">
                    <label for="image" class="btn btn-primary"><i class="fa-solid fa-image"></i> Change</label>
