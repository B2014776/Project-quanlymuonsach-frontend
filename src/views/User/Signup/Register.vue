        ...
        <div class=" row d-flex justify-content-center align-items-center h-100">
          <div class=" col col-xl-10">
            <div class=" card loginForm">
              <div class="bg-[#F8DAD0] row g-0 rounded-xl">
                <div class="col-md-6 col-lg-6">
                  <div class="wrapper">
                    <img class="rounded-xl"
                      src="D:/project_daydu_ct499/quanlimuonsach_frontend/public/panda2.jpg">
                  </div>
                </div>
                <div class="col-md-6 col-lg-6 d-flex align-items-center">
                  <div class="card-body p-2 p-lg-4 text-black">
                    <form @submit.prevent="register" enctype="multipart/form-data">
                      ...
                      <div class="group">
                        <label for="birth"><i class="fa-solid fa-user iconForm"></i></label>
                      ...
                      <div class="pt-1 mb-4">
                        <button class="bg-[#2D99AE] w-full h-11 rounded-[11px] shadow-[20px]">SIGN UP</button>
                      </div>

                      <router-link to="/login">
                        <div>
                          <button class="bg-[#0C5776] w-full h-11 rounded-[11px] shadow-[20px] text-[#000]">SIGN IN</button>
                        </div>
                      </router-link>
                    </form>
                  </div>
